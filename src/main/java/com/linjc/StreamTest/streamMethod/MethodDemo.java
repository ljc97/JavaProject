package com.linjc.StreamTest.streamMethod;

import com.linjc.StreamTest.demo.Person;
...
//        Stream<Person> personStream = Stream.of(new Person("aa"), new Person("ss"), new Person("dd"));
//        Map<String, String> map = personStream.collect(Collectors.toMap(Person::getName, Person::getName));
...
//        删除key为2的数据
//        Stream<Map<String, Person>> mapStream = stream.filter(e -> e.get("2").getName().startsWith("b"));
